            ...
            <div className=' grid grid-cols-1 lg:grid-cols-3 gap-7 lg:gap-5'>
                ...
                <div className=' border bg-white rounded-3xl shadow-md'>
                    ...
                    <div className='  bottom-0 z-30 p-7 '>
                        ...
                        <p className=' text-black mt-3'>Delivering high-quality materials for every stage of your construction journey, from foundation to finish.</p>
                    </div>
                </div>
                <div className=' border bg-white rounded-3xl shadow-md'>
                    <div className='h-[25rem] border overflow-hidden shadow-lg  relative rounded-3xl '>
                    ...
                    <div className=' z-30 p-7 '>
                        <h1 className=' text-black font-bold text-xl'>Machinery Supply
                        </h1>
                        <p className=' text-black mt-3'>Providing advanced machinery to ensure efficiency and precision in every project.
                        </p>
                    </div>
                </div>
            </div>
